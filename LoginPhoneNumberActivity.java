            ...
            buttonVerify.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (!userInputPhoneNumber.isEmpty()) {
                        ...
                        Toast.makeText(LoginPhoneNumberActivity.this, "Please enter your phone number", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        if (storedPhoneNumber.equals(userInputPhoneNumber)) {
                            ...
                            Toast.makeText(LoginPhoneNumberActivity.this, "Phone number verified", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(LoginPhoneNumberActivity.this, "Phone number does not match", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        // User ID not found in database or no phone number stored
                        Toast.makeText(LoginPhoneNumberActivity.this, "User not found or no phone number stored", Toast.LENGTH_SHORT).show();
                    }
                }
